...
class UserListAdapter : RecyclerView.Adapter<UserListAdapter.UserViewHolder>() {
  ...
  override fun onCreateViewHolder(
    ...
    val binding = DataBindingUtil.inflate<RowUserBinding>(
        LayoutInflater.from(parent.context), R.layout.row_user, parent, false
    )
  ...
  inner class UserViewHolder(private val binding: RowUserBinding) : RecyclerView.ViewHolder(
      binding.root
