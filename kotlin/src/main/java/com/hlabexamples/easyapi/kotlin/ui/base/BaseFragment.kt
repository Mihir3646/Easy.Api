 ...
 */
abstract class BaseFragment<T : ViewDataBinding> : Fragment(), View.OnClickListener, LoaderInterface {
     ...
     */
    protected fun add(container: Int, currentFragment: Fragment, nextFragment: Fragment) {
        if (fragmentManager != null) {
            fragmentManager!!.beginTransaction().add(container, nextFragment, nextFragment.javaClass.simpleName).hide(currentFragment).addToBackStack(null).commit()
        }
    }
}